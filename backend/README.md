...
## Project Structure
    ...
    ├── testapiautoteammemb_82834  # Django project configurations
...
1. Clone this repo and `cd testapiautoteammemb_82834`
...
2. Clone this repo and `cd testapiautoteammemb_82834`
